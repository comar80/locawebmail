...
@Composable
fun ArquivoScreen(navController: NavController, context: Context, isDarkMode: Boolean, onThemeChange: (Boolean)->Unit ) {
                ...
                Box(modifier = Modifier.height(500.dp)) {
                    LazyColumn {
                        try {
                            ...
                            val emailsEntrada = caixaRepository.getUmaCaixaComEmails(3)
